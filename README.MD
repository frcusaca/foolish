...
have observably limited size. Cells can only be so big before the member stops
working. Subnuclear objects has to be so close or otherwise the forces that keep
