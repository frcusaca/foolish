...
The brane is a one dimentional object. Its entries line up one after another.
...
context, and evaluate that expression using the context "IB AB ↑". That says the UBC shall
