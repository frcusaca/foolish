...
public abstract class FIR implements Cloneable {
    ...
    protected final Either<AST, String> sourceCode;
    ...
    protected FIR(AST ast, String comment, boolean ai) {
        this(ast != null ? new Either.One<>(ast) : null, comment, ai);
    }

    protected FIR(Either<AST, String> sourceCode, String comment, boolean ai) {
        this.sourceCode = sourceCode;
        this.ast = sourceCode != null ? sourceCode.fold(a -> a, s -> null) : null;
    ...
    public Either<AST, String> sourceCode() {
        return sourceCode;
    }
    ...
    protected static FIR createFiroeFromExpr(AST.Expr expr) {
        switch (expr) {
            ...
            case AST.Identifier identifier -> {
                return new LocalSearchFiroe(new Either.One<>(identifier));
            }
            case AST.RegexpSearchExpr regexpSearch -> {
                if (regexpSearch.anchor() != null && DerefSearchFiroe.isExactMatch(regexpSearch.pattern())) {
