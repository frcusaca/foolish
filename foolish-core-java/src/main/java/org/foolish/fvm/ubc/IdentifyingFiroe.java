...
/**
 * IdentifyingFiroe represents a characterized identifier reference in the UBC system.
 *
...
public class IdentifyingFiroe extends FiroeWithBraneMind implements Constanicable {
     ...
     */
    protected IdentifyingFiroe(IdentifyingFiroe original, FIR newParent) {
    ...
    protected FIR cloneConstanic(FIR newParent, Optional<Nyes> targetNyes) {
        ...
        IdentifyingFiroe copy = new IdentifyingFiroe(this, newParent);
