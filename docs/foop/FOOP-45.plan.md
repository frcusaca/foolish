# FOOP-45.plan — deadbrane

Worktree variables (expanded):
- WORKTREE_ORIGIN_BRANCH=jia
- WORKTREE_ORIGIN_PATH=/home/hcbusy/foolish-rust
- WORKTREE_BRANCH_NAME=foop-45-deadbrane
- WORKTREE_FULL_FS_PATH=/home/hcbusy/tmp/foolish-worktrees/foop-45-deadbrane

---

- [ ] Begin work: commit FOOP-45.md and FOOP-45.plan.md to origin, check `begun: [x]` in frontmatter
      (YYYY-MM-DD HH:MM)
- [ ] Create worktree at /home/hcbusy/tmp/foolish-worktrees/foop-45-deadbrane with branch `foop-45-deadbrane`

### Part A: FirID cloning semantics tests

- [ ] (read §FirID cloning semantics of FOOP-45.md)
...
- [ ] (read §FoolishIndex of FOOP-45.md)
...
- [ ] (read §Deadbrane analysis of FOOP-45.md — frame of reference = (brane, FI))
...
- [ ] Verify all work is complete in /home/hcbusy/tmp/foolish-worktrees/foop-45-deadbrane and committed to `foop-45-deadbrane`
- [ ] Run `cargo clippy -D warnings` — zero warnings
- [ ] Run `cargo fmt --check` — no formatting needed
- [ ] Run `cargo test --workspace` — all tests pass
- [ ] Merge `foop-45-deadbrane` to `jia`
- [ ] STOP! STOP!! STOP!!! ASK HUMAN to check this box before continuing. UNDER NO CIRCUMSTANCES will Agent continue past this point automatically!!
  - [ ] Present human with the `cd /home/hcbusy/tmp/foolish-worktrees/foop-45-deadbrane` command and ask them to review snapshots BEFORE checking the parent checkbox.
- [ ] Cleanup /home/hcbusy/tmp/foolish-worktrees/foop-45-deadbrane
  - [ ] Check that .plan.md has all but Cleanup checkboxes completed
  - [ ] Remove /home/hcbusy/tmp/foolish-worktrees/foop-45-deadbrane
