...
public class FoolishLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT_T", "FLOAT_T", "STRING_T", "BRANE_T", "ARROW", "ASSIGN", "ASSIGN_DEREF", 
			...
			"PRIM_QUOTE", "TYPE_KIND", "PRIMITIVE_IDENTIFIER", "TYPE_IDENTIFIER", 
			"ORD_IDENTIFIER", "NUMBER", "DIGITS", "LINE_COMMENT", "BLOCK_COMMENT", 
			"WS", "NEWLINE"
		};
	}
